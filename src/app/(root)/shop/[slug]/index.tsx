...
export const Index = () => {
  ...
  return (
    <div className="bg-[#F4F2EE] px-[20px] pb-[150px] pt-[50px]">
        ...
        <div>
          <div className="flex flex-row items-center justify-between" key={i}>
            <div className="w-[32%]">
              ...
              <div className="mt-[50px] flex w-[400px] flex-row items-center justify-between rounded-[25px] bg-black pr-[30px] text-white">
          ...
          <div className="flex flex-row items-center gap-[10px]">
            ...
            <div className="w-[30%] text-[14px]">
              ...
              cung cấp nguồn dinh dưỡng phong phú, đáp ứng nhu cầu của mèo ở mọi
              lứa tuổi.
              <br />
              <strong>Thành phần</strong>: Thức ăn chứa protein từ thịt gà, cá
              và các nguồn thực phẩm khác, giúp xây dựng và duy trì cơ bắp.
              Ngoài ra, sản phẩm còn bổ sung chất béo lành mạnh, vitamin A, D, E
              và khoáng chất như canxi, phốt pho để tăng cường hệ miễn dịch và
              hỗ trợ sức khỏe xương khớp. Các axit béo omega-3 và omega-6 trong
              công thức giúp cải thiện tình trạng da và lông, mang đến bộ lông
              bóng mượt.
              <br />
              Với thức ăn cho mèo giàu chất dinh dưỡng, bạn có thể yên tâm mang
              lại cho thú cưng một chế độ ăn uống lành mạnh, góp phần kéo dài
              tuổi thọ và cải thiện chất lượng cuộc sống của chúng. Hãy chọn sản
              phẩm này để chăm sóc sức khỏe cho mèo yêu của bạn!
            </div>
            <div className="w-[35%]">
              <Image
                src={item.productThumbnail}
