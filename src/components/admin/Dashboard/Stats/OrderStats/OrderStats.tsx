...
export default function OrderStats() {
  ...
  return (
    <div className="mt-8 w-full rounded-lg bg-white p-8 shadow-lg dark:bg-[#18181b] dark:text-white">
      ...
      <div className="mt-8">
        <h2 className="mb-4 text-3xl font-semibold">Doanh thu đơn hàng</h2>
        <div className="space-y-5">
          ...
          <div className="flex justify-between">
            <span className="font-medium">Số đơn hàng đang xử lý</span>
            <span className="text-gray-500">{data.orderPending} đơn</span>
          </div>
          <div className="flex justify-between">
            <span className="font-medium">Số đơn hàng đang giao</span>
            <span className="text-gray-500">{data.orderDelivering} đơn</span>
          </div>
          <div className="flex justify-between">
