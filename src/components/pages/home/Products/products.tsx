    ...
    return (
        <div className="px-[40px] mt-[80px]">
                    ...
                    {data?.map((item) => (
                        <div>
                            <div className="relative">
                                <img src={process.env.NEXT_PUBLIC_API_URL + 'public/images/products/' + item.productImage} width="470px" className="rounded-[10px]" />
                                <div className="absolute bottom-[20px] left-[10px] flex flex-row justify-between items-center w-[450px]">
                                    ...
                                    <div className="bg-black px-[25px] py-[8px] rounded-[20px]">
                                        <p className="text-white text-[15px]">{numeral(item.productPrice).format('$0,')}</p>
                                    </div>
                                </div>
            ...
            <div className="flex items-center justify-center w-[100%] mt-[50px]">
                <button className="border border-black px-[70px] py-[10px] rounded-[30px] font-[500]">XEM THÊM</button>
            </div>
        </div>
    )
}